  ...
  const Logo = () => {
    ...
    return (
      <div className='w-[90%] flex justify-between items-center font-navLogo font-[700] text-subTitleFont bg-[white]'>
        ...
        <div className={`${focused ? 'w-[300px]' : 'w-[35px]'} ${focused ? 'sm:w-[180px]' : 'sm:w-[35px]'} ${focused ? 'xsm:w-[120px]' : 'xsm:w-[35px]'} h-[35px] ${focused ? 'px-1 pr-3' : 'px-0'} bg-[white] rounded rounded-[5px] flex justify-start border ${focused ? 'border-[black]' : 'border-[white]'} items-center
        ...
        >
          ...
          <input type="search" className={`${focused ? 'w-[280px]' : 'w-[0px]'} ${focused ? 'sm:w-[130px]' : 'sm:w-[0px]'} ${focused ? 'xsm:w-[80px]' : 'xsm:w-[0px]'} h-[30px] outline-none border-none bg-[white] ${focused ? 'text-[black]' : 'text-[white]'} 
            text-[20px] font-normal duration-[2000ms] delay-[1000ms] transition-all transition-slowest ease
          `} />
  ...
  return (
    ...
    >
      <div className='w-[80%] sm:w-[95%] flex justify-between items-center bg-[white] text-[black]'>
        ...
        {/* <BiLogOut className='text-[red] color-[red] font-navLogo text-[35px]'/> */}
      </div>
