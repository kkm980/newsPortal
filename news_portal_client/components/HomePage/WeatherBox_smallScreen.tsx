...
const WeatherBox_smallScreen: React.FC<IProps> = () => {
    ...
    const WeatherChart=()=>{
        return(
            <div className='w-[300px] lg:w-[200px] h-[250px] xl:h-[190px] mt-[30px] xl:mt-[10px] lg:mt-[8px] bg-[white]
               flex flex-col justify-between items-center'>


                <div className='w-[100%] bg-[white] flex justify-between items-center'>
                    <div className='bg-[white] font-[700] text-[20px] lg:text-[14px] text-[#7F7F7F] font-subTitle'>
                        Thursday
                    </div>
  ...
  return (
      <div className={`w-[28%] xl:w-[35%] lg:w-[40%] mt-[45px] bg-[white] flex flex-col items-end justify-start md:hidden`}>
          <div className='text-titleFont lg:text-[18px] font-[700] font-title text-[#2F80ED] bg-[white]'>Wednesday 29 Dec 21'</div>
          <div className='bg-[white] text-[black]'>
              <div className='w-[300px] lg:w-[200px] h-[108px] mt-[45px] xl:mt-[20px] pl-6 px-4 lg:px-2 bg-[white] rounded rounded-[8px]
               flex justify-between items-center drop-shadow-[2px_5px_25px_rgba(0,0,0,0.05)]'>
